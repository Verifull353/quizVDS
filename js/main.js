...
//     xhr.open('GET', 'https://tenz-development-tenz.c9users.io/quizVDS/js/quiz_VDS.sqlite', true);
...
$(document).ready(
  function(){
        ...
        loadBinaryFile('https://tenz-development-tenz.c9users.io/quizVDS/js/quiz_VDS.sqlite', function(data){
